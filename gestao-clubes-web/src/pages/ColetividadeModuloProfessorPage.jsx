...
export default function ColetividadeModuloProfessorPage() {
    ...
    return (
        <>
            <SideMenu
                title="Módulo Professor"
                subtitle={coletividade?.nome || "Coletividade"}
                logoHref={`/coletividades/${coletividadeId}/professor`}
            ...
            <div className="container" style={{ paddingTop: 24 }}>
                <div className="page-title">
                    <div>
                        <h1>Módulo Professor / Treinador</h1>
                        ...
                        <section className="card">
                            ...
                            {atividadeAtiva ? (
                                <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                                    ...
                                    {nome && (
                                        <div className="subtle">Professor responsável: <strong>{nome}</strong></div>
                                    )}
                                </div>
                            ) : (
                                <p className="subtle">
