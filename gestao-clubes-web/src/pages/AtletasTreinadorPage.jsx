...
export default function AtletasTreinadorPage() {
    ...
    return (
        <>
            <SideMenu title="Gestão de Clubes" subtitle="Atletas" logoHref="/menu" logoSrc="/LOGO_GCDC04.png" items={menuItems} />
